class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    #   The ordering of the field names is the order of the display
    config.add_index_field solr_name("identifier", :stored_searchable), itemprop: 'identifier', link_to_search: solr_name("identifier", :facetable)
    ...
    config.add_index_field solr_name("date_created", :stored_searchable), itemprop: 'dateCreated', label: "Date"
