...
module Hyrax
  class GenericWorkForm < Hyrax::Forms::WorkForm
    ...
    def required_fields
      [:title, :identifier, :date_created, :digitized]
    end
  end
end
